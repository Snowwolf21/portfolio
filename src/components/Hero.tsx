...
import TransformativeStackCard from "../components/TransformativeStackCard/index";
import kunmi from '../asset/Kunmi.jpeg'
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left scroll-reveal">
          ...
          <p className="text-base text-secondary leading-relaxed mb-6 max-w-xl">
            I&apos;m <span className="text-foreground font-semibold">Akinkunmi</span>, a frontend developer who ships responsive, accessible UIs with 
             <span className="text-foreground font-medium"> React</span>,
             <span className="text-foreground font-medium"> TypeScript</span>,
              and <span className="text-foreground font-medium">Tailwind CSS</span>. 
              I obsess over the details that make products feel polished:
               smooth transitions, clean component APIs, and layouts that just work on every screen.
          </p>

          <p className="text-base text-secondary leading-relaxed mb-10 max-w-xl">
            Recently, I&apos;ve been building full-stack projects with <span className="text-foreground font-medium">Node.js</span>,
             <span className="text-foreground font-medium"> Express</span>, and 
             <span className="text-foreground font-medium"> MongoDB </span>
              not because it&apos;s trendy, but because I got tired of handing off half-finished work to a backend team.
          </p>
          ...
          <div className="flex flex-col justify-center items-center sm:flex-row gap-4 w-full sm:w-auto">
            <Link
              href="#projects"
              className=" w-[50vw] sm:w-auto px-8 py-3.5 rounded-xl bg-accent text-white font-medium hover:bg-accent-hover active:scale-[0.98] transition-all duration-200 text-center shadow-lg shadow-accent/25 hover:shadow-accent/40 cursor-pointer"
            >
              See What I&apos;ve Built
            </Link>
            <Link
              href="#contact"
              className="px-8 py-3.5 rounded-xl border border-card-border font-medium hover:bg-accent/60 hover:border-accent hover:text-accent active:scale-[0.98] transition-all duration-200 text-center glass-panel cursor-pointer"
            >
              Get in Touch
            </Link>
          </div>
