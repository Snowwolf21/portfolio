      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {frontendSkills.map((skill) => (
            <div 
              key={skill.name}
              className="p-4 rounded-2xl border border-white/10 bg-white/5 dark:bg-zinc-900/50 hover:border-accent/40 hover:bg-white/10 dark:hover:bg-zinc-900/80 transition-all duration-300 group flex flex-col justify-between h-[90px] shadow-sm hover:shadow-lg"
            >
