  ...
  return (
    <div className="relative flex justify-center items-center">
      ...
      <div className="relative h-[480px] w-[320px] sm:h-[500px] sm:w-[400px] group">
        ...
        <div className="absolute inset-0 rounded-[3rem] bg-linear-to-br from-accent to-purple-500 p-[1.5px] shadow-2xl">
        ...
        <div className="absolute -right-6 top-1/2 -translate-y-1/2 z-20 animate-[float_5s_ease-in-out_infinite_1.5s]">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-accent to-purple-600 border border-white/20 shadow-xl shadow-accent-glow/40 transform rotate-12 hover:rotate-0 transition-transform duration-300">
