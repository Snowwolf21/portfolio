...
export const stack: StackItem[] = [
  ...
  },
  {
    ...
    title: "Backend",
    items: [
      { name: "Node.js", iconName: "Node", level: 65, color: "#339933" },
      { name: "Express.js", iconName: "Express", level: 70, color: "#828282" },
      { name: "MongoDB", iconName: "Mongo", level: 70, color: "#47A248" },
      // { name: "PostgreSQL", iconName: "Postgres", level: 65, color: "#2196F3" },
      { name: "REST APIs", iconName: "Rest", level: 75, color: "#00c8ff" },
      { name: "JWT Auth", iconName: "Jwt", level: 70, color: "#fb015b" },
      { name: "Git / Version Control", iconName: "Git", level: 75, color: "#F05032" },
      { name: "Vercel", iconName: "Vercel", level: 90, color: "#2661FA" },
    ],
  },
];